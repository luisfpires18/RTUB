...
public class DriveEventStorageServiceTests : IDisposable
{
    private readonly Mock<IConfiguration> _configurationMock;
    private readonly Mock<ILogger<DriveEventStorageService>> _loggerMock;
    private DriveEventStorageService? _service;

    public DriveEventStorageServiceTests()
    {
        _configurationMock = new Mock<IConfiguration>();
        _loggerMock = new Mock<ILogger<DriveEventStorageService>>();
    ...
    public void Constructor_WithMissingAccessKey_ThrowsInvalidOperationException()
    {
        ...
        // Act & Assert
        var act = () => new DriveEventStorageService(_configurationMock.Object, _loggerMock.Object);
    ...
    {
        // Arrange
        _service = new DriveEventStorageService(_configurationMock.Object, _loggerMock.Object);
