...
public class DriveInstrumentStorageServiceTests : IDisposable
{
    private readonly Mock<IConfiguration> _configurationMock;
    private readonly Mock<ILogger<DriveInstrumentStorageService>> _loggerMock;
    private DriveInstrumentStorageService? _service;

    public DriveInstrumentStorageServiceTests()
    {
        _configurationMock = new Mock<IConfiguration>();
        _loggerMock = new Mock<ILogger<DriveInstrumentStorageService>>();
    ...
    public void Constructor_WithMissingAccessKey_ThrowsInvalidOperationException()
    {
        ...
        // Act & Assert
        var act = () => new DriveInstrumentStorageService(_configurationMock.Object, _loggerMock.Object);
    ...
    {
        // Arrange
        _service = new DriveInstrumentStorageService(_configurationMock.Object, _loggerMock.Object);
    ...
    public async Task GetImageUrlAsync_WithValidFilename_ReturnsPublicUrl()
    {
        // Arrange
        _service = new DriveInstrumentStorageService(_configurationMock.Object, _loggerMock.Object);
        var filename = "instrument_1_20241108000000.webp";
