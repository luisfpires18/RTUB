...
public class DriveProfileStorageServiceTests : IDisposable
{
    private readonly Mock<IConfiguration> _configurationMock;
    private readonly Mock<ILogger<DriveProfileStorageService>> _loggerMock;
    private DriveProfileStorageService? _service;

    public DriveProfileStorageServiceTests()
    {
        _configurationMock = new Mock<IConfiguration>();
        _loggerMock = new Mock<ILogger<DriveProfileStorageService>>();
    ...
    public void Constructor_WithMissingAccessKey_ThrowsInvalidOperationException()
    {
        ...
        // Act & Assert
        var act = () => new DriveProfileStorageService(_configurationMock.Object, _loggerMock.Object);
    ...
    {
        // Arrange
        _service = new DriveProfileStorageService(_configurationMock.Object, _loggerMock.Object);
    ...
    [Fact]
    public async Task GetImageUrlAsync_WithValidFilename_ReturnsPresignedUrl()
    {
        // Arrange
        _service = new DriveProfileStorageService(_configurationMock.Object, _loggerMock.Object);
        var filename = "testuser_20240101120000.webp";
    ...
    public async Task UploadImageAsync_WithNullFile_ThrowsArgumentException()
    {
        ...
        // Act
        var act = async () => await _service.UploadImageAsync((IFormFile)null!, "testuser");
    ...
    [Fact]
    public async Task UploadImageAsync_WithEmptyUsername_ThrowsArgumentException()
    {
        // Arrange
        _service = new DriveProfileStorageService(_configurationMock.Object, _loggerMock.Object);
        ...
        // Act
        var act = async () => await _service.UploadImageAsync(mockFile.Object, string.Empty);
    ...
    public async Task UploadImageAsync_WithNullImageData_ThrowsArgumentException()
    {
        ...
        // Act
        var act = async () => await _service.UploadImageAsync((byte[])null!, "testuser", "image/jpeg");
    ...
    public async Task UploadImageAsync_WithEmptyImageData_ThrowsArgumentException()
    {
        ...
        // Act
        var act = async () => await _service.UploadImageAsync(Array.Empty<byte>(), "testuser", "image/jpeg");
    ...
    [Fact]
    public async Task UploadImageAsync_WithEmptyContentType_ThrowsArgumentException()
    {
        // Arrange
        _service = new DriveProfileStorageService(_configurationMock.Object, _loggerMock.Object);
        var imageData = new byte[] { 0xFF, 0xD8, 0xFF }; // Minimal JPEG data

        // Act
        var act = async () => await _service.UploadImageAsync(imageData, "testuser", string.Empty);
