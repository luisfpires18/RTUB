...
public class DriveAlbumStorageServiceTests : IDisposable
{
    private readonly Mock<IConfiguration> _configurationMock;
    private readonly Mock<ILogger<DriveAlbumStorageService>> _loggerMock;
    private DriveAlbumStorageService? _service;

    public DriveAlbumStorageServiceTests()
    {
        _configurationMock = new Mock<IConfiguration>();
        _loggerMock = new Mock<ILogger<DriveAlbumStorageService>>();
    ...
    public void Constructor_WithMissingAccessKey_ThrowsInvalidOperationException()
    {
        ...
        // Act & Assert
        var act = () => new DriveAlbumStorageService(_configurationMock.Object, _loggerMock.Object);
    ...
    {
        // Arrange
        _service = new DriveAlbumStorageService(_configurationMock.Object, _loggerMock.Object);
