...
/// </summary>
public class LogisticsListServiceTests : IClassFixture<DatabaseFixture>, IDisposable
{
    private readonly ApplicationDbContext _context;
    private readonly DatabaseFixture _fixture;
    private readonly LogisticsListService _service;

    public LogisticsListServiceTests(DatabaseFixture fixture)
    {
        ...
        _service = new LogisticsListService(listRepo, cardRepo);
    }
