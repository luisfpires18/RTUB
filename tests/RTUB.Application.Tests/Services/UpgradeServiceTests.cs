...
public class UpgradeServiceTests : IClassFixture<DatabaseFixture>, IDisposable
{
    ...
    public UpgradeServiceTests(DatabaseFixture fixture)
    {
        ...
        var inventoryRepository = new Mock<IInventoryRepository>().Object;
        _characterService = new CharacterService(characterRepository, _context, inventoryRepository);
    ...
    public async Task GetUpgradeCostAsync_WithUpgrades_ShouldScaleCorrectly()
    {
        ...
        // Assert
        // Formula: 50 * (1 + 2) ^ 1.5 = 50 * 3^1.5 = 50 * 5.196 = 259.8
        cost.Should().BeApproximately(259.8m, 0.1m);
    }
