...
/// Testing kanban board behavior. Authorization lives in LogisticsAuthorizationTests.
/// </summary>
public class LogisticsBoardPageTests
{
    // The Card Modal Access and Admin Controls regions that stood here asserted local
    // booleans and string literals, so they passed whatever the page did - and they described
    // the pre-030 Admin-only rule. Behaviour is pinned by LogisticsAuthorizationTests.
