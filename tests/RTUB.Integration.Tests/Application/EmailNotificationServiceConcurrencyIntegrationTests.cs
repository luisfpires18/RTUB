...
/// <summary>
/// Integration tests for concurrent email sending to verify ObjectDisposedException fix.
/// Converted from unit tests to integration tests for faster execution without database overhead.
/// </summary>
public class EmailNotificationServiceConcurrencyIntegrationTests : IDisposable
{
    ...
    {
        // Arrange - reduced to 10 recipients for faster execution
    ...
    {
        // Arrange - reduced to 8 recipients for faster execution
    ...
    {
        // Arrange - reduced to 9 recipients for faster execution
