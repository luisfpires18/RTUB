...
/// <summary>
/// The year-one crime catalogue (Game Manual v2). Cargo rewards arrive in AH-004 and are not
/// modelled or awarded here.
/// </summary>
public static class CrimeCatalogue
{
    ...
    [
        new("C01", "Lift a phone outside the bar", 1, 10, 82, 35, 20, 3, PlayerSkill.Stealth,
            "You slipped the phone before the owner noticed."),
        ...
        new("C03", "Fake a venue invoice", 3, 14, 76, 60, 34, 4, PlayerSkill.Smarts,
            "The venue paid the invoice without a second look."),
        new("C04", "Sell counterfeit event tickets", 4, 14, 74, 70, 36, 4, PlayerSkill.Charisma,
            "Every fake ticket was gone before the doors opened."),
