...
namespace RTUB.Migrations
{
    ...
    [Migration("20260925125645_AddAfterHoursObjectives")]
    partial class AddAfterHoursObjectives
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RTUB.Core.Entities.AfterHours.Family", b =>
                {
                    ...
                    b.HasIndex("NormalizedName")
                        .IsUnique()
                        .HasDatabaseName("IX_AfterHoursFamilies_NormalizedName");

                    b.ToTable("AfterHoursFamilies", (string)null);
                });
            ...
            modelBuilder.Entity("RTUB.Core.Entities.AfterHours.FamilyCycleState", b =>
                {
                    ...
                    b.HasIndex("FamilyId", "GameCycleId")
                        .IsUnique()
                        .HasDatabaseName("IX_AfterHoursFamilyCycleStates_Family_Cycle");

                    b.ToTable("AfterHoursFamilyCycleStates", null, t =>
                        {
                            t.HasCheckConstraint("CK_AfterHoursFamilyCycleStates_Treasury", "\"TreasuryCash\" >= 0");
                        });
                });

            modelBuilder.Entity("RTUB.Core.Entities.AfterHours.FamilyInvitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("FamilyId", "InvitedUserId")
                        .IsUnique()
                    ...
                    b.ToTable("AfterHoursFamilyInvitations", (string)null);
                });

            modelBuilder.Entity("RTUB.Core.Entities.AfterHours.FamilyMembership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("FamilyId")
                        ...
                        .HasFilter("\"LeftAtUtc\" IS NULL AND \"Role\" = 1");
            ...
            modelBuilder.Entity("RTUB.Core.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("PushNotificationsOptedOut")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RTUB.Core.Entities.Enrollment", b =>
                {
                    ...
                    b.Property<int?>("CategoryAtEvent")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RTUB.Core.Entities.EventContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RTUB.Core.Entities.MessageReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RTUB.Core.Entities.RehearsalAttendance", b =>
                {
                    ...
                    b.Property<int?>("CategoryAtRehearsal")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RTUB.Core.Entities.Transportation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RTUB.Core.Entities.TransportationPassenger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RTUB.Core.Entities.AfterHours.FamilyMembership", b =>
                {
                    b.HasOne("RTUB.Core.Entities.AfterHours.Family", "Family")
                        .WithMany()
                        .HasForeignKey("FamilyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("RTUB.Core.Entities.MessageReaction", b =>
                {
                    b.HasOne("RTUB.Core.Entities.Message", "Message")
                        .WithMany("Reactions")
            ...
            modelBuilder.Entity("RTUB.Core.Entities.Transportation", b =>
                {
                    b.HasOne("RTUB.Core.Entities.Post", "Post")
                        ...
                        .HasForeignKey("RTUB.Core.Entities.Transportation", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RTUB.Core.Entities.TransportationPassenger", b =>
                {
                    b.HasOne("RTUB.Core.Entities.ApplicationUser", "Passenger")
                        .WithMany()
                        .HasForeignKey("PassengerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RTUB.Core.Entities.Transportation", "Transportation")
                        .WithMany("Passengers")
