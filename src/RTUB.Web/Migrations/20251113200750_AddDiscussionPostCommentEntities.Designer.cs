...
namespace RTUB.Migrations
{
    ...
    [Migration("20251113200750_AddDiscussionPostCommentEntities")]
    partial class AddDiscussionPostCommentEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RTUB.Core.Entities.Discussion", b =>
                {
                    b.HasOne("RTUB.Core.Entities.Event", "Event")
                        .WithOne("Discussion")
                        .HasForeignKey("RTUB.Core.Entities.Discussion", "EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
