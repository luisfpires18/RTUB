...
namespace RTUB.Migrations
{
    ...
    [Migration("20260302184016_AddVillageEntities")]
    partial class AddVillageEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RTUB.Core.Entities.Village", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RTUB.Core.Entities.VillageBuildJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("FieldResourceType")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("FieldSlotIndex")
                        .HasColumnType("INTEGER");

                    b.Property<DateTime>("FinishesAt")
                        .HasColumnType("TEXT");

                    b.Property<bool>("IsFieldUpgrade")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("VillageBuildJobs");
                });

            modelBuilder.Entity("RTUB.Core.Entities.VillageBuilding", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("VillageId", "BuildingType")
                        .IsUnique()
            ...
            modelBuilder.Entity("RTUB.Core.Entities.VillageField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("VillageId", "ResourceType", "SlotIndex")
                        .IsUnique()
                        .HasDatabaseName("IX_VillageFields_Village_Resource_Slot");

                    b.ToTable("VillageFields");
                });

            modelBuilder.Entity("RTUB.Core.Entities.VillageMission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("SentTroopsJson")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("VillageMissions");
                });

            modelBuilder.Entity("RTUB.Core.Entities.VillageTroop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("VillageId", "UnitType")
                        .IsUnique()
                        .HasDatabaseName("IX_VillageTroops_Village_Unit");

                    b.ToTable("VillageTroops");
                });
            ...
            modelBuilder.Entity("RTUB.Core.Entities.VillageBuildJob", b =>
                {
                    b.HasOne("RTUB.Core.Entities.Village", "Village")
                        .WithOne("ActiveBuildJob")
                        .HasForeignKey("RTUB.Core.Entities.VillageBuildJob", "VillageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
