...
public static partial class SeedData
{
    public static async Task SeedSlideshowsAsync(ApplicationDbContext dbContext)
    {
        ...
        if (!await dbContext.Slideshows.AnyAsync())
        {
            ...
            slideshow1.ImageUrl = "https://placeholder.com/slideshow1.jpg";
            slideshow1.Activate();
            ...
            slideshow2.ImageUrl = "https://placeholder.com/slideshow2.jpg";
            slideshow2.Activate();
            ...
            slideshow3.ImageUrl = "https://placeholder.com/slideshow3.jpg";
            slideshow3.Activate();
