...
/// </summary>
public class DriveSlideshowStorageService : BaseDriveStorageService, ISlideshowStorageService
{
    ...
    protected override int WebPQuality => 100; // Higher quality for slideshow images
