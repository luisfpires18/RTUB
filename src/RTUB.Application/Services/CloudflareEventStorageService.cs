...
/// <summary>
/// Implementation of event storage service using Cloudflare R2 (S3-compatible)
/// </summary>
public class CloudflareEventStorageService : BaseCloudflareStorageService, IEventStorageService
{
    protected override string PathPrefix => "images/events/";
    protected override int MaxImageWidth => 1200;
    protected override int MaxImageHeight => 800;
    protected override int WebPQuality => 85;
    protected override string EntityName => "event";

    public CloudflareEventStorageService(IConfiguration configuration, ILogger<CloudflareEventStorageService> logger)
