...
/// <summary>
/// Implementation of product storage service using Cloudflare R2 (S3-compatible)
/// </summary>
public class CloudflareProductStorageService : BaseCloudflareStorageService, IProductStorageService
{
    ...
    public CloudflareProductStorageService(IConfiguration configuration, ILogger<CloudflareProductStorageService> logger)
