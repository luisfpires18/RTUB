...
public interface ILogisticsBoardService
{
    ...
    Task<(IEnumerable<LogisticsBoard> Boards, int TotalCount)> GetBoardsPagedAsync(int page, int pageSize, string? searchTerm = null, bool? isCompleted = null);
    ...
    Task MarkBoardAsCompletedAsync(int id);
    Task MarkBoardAsNotCompletedAsync(int id);
}
