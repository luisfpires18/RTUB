...
public interface ISlideshowService
{
    ...
    Task UpdateSlideshowWithImageAsync(int id, string title, string description, int order, int intervalMs, Stream imageStream, string fileName, string contentType);
