...
> Generated from `scaling.config.json` v6.0.0. Tier base stats are **flat per tier**; actual in-game stats are tier × stageMult × 1.01 (see Progressive Stage Multiplier section).

> **v6 changes:** Biome enemy crit values updated (4%–50% scaling); global `enemyStatBuff: 1.01` added (+1% to HP, Power, Defense at every stage).
...
> These are **tier base stats** before stage scaling. Multiply by `stageMult × 1.01` for effective in-game values.

| Tier | Floors | HP | Power | Defense | Speed | Crit | Fidelis | XP |
|:---:|:---|---:|---:|---:|:---:|:---:|---:|---:|
| 1 | 1–1,000 | 150 | 15 | 10 | 8 | 4% | 30 | 20 |
| 2 | 1,001–2,000 | 350 | 30 | 25 | 9 | 4% | 55 | 40 |
| 3 | 2,001–3,000 | 700 | 55 | 45 | 9 | 8% | 85 | 65 |
| 4 | 3,001–4,000 | 1,200 | 90 | 70 | 10 | 8% | 110 | 85 |
| 5 | 4,001–5,000 | 1,900 | 140 | 110 | 10 | 12% | 140 | 110 |
| 6 | 5,001–6,000 | 2,800 | 200 | 160 | 11 | 12% | 170 | 130 |
| 7 | 6,001–7,000 | 4,000 | 280 | 220 | 11 | 16% | 210 | 155 |
| 8 | 7,001–8,000 | 5,800 | 380 | 300 | 12 | 16% | 260 | 180 |
| 9 | 8,001–9,000 | 8,000 | 500 | 400 | 12 | 20% | 310 | 200 |
| 10 | 9,001–10,000 | 11,000 | 650 | 520 | 13 | 20% | 370 | 230 |
| 11 | 10,001–11,000 | 14,000 | 820 | 660 | 13 | 24% | 430 | 260 |
| 12 | 11,001–12,000 | 17,500 | 1,020 | 830 | 14 | 24% | 500 | 290 |
| 13 | 12,001–13,000 | 22,000 | 1,280 | 1,050 | 14 | 28% | 570 | 320 |
| 14 | 13,001–14,000 | 27,500 | 1,600 | 1,320 | 14 | 28% | 650 | 350 |
| 15 | 14,001–15,000 | 34,000 | 2,000 | 1,660 | 15 | 32% | 740 | 380 |
| 16 | 15,001–16,000 | 42,000 | 2,500 | 2,080 | 15 | 32% | 840 | 420 |
| 17 | 16,001–17,000 | 52,000 | 3,120 | 2,600 | 15 | 36% | 950 | 460 |
| 18 | 17,001–18,000 | 65,000 | 3,900 | 3,250 | 16 | 36% | 1,070 | 500 |
| 19 | 18,001–19,000 | 81,000 | 4,880 | 4,060 | 16 | 40% | 1,200 | 540 |
| 20 | 19,001–20,000 | 100,000 | 6,100 | 5,080 | 17 | 40% | 1,350 | 580 |
| 21 | 20,001+ (Arena) | 125,000 | 7,620 | 6,350 | 17 | 50% | 1,500 | 620 |
...
## Progressive Stage Multiplier

Every stage floor adds a continuous scaling factor on top of tier base stats:

$$\text{stageMult} = 1.0 + (\text{stageNumber} - 1) \times 0.0015$$

Then the **global enemy stat buff** (`enemyStatBuff: 1.01`) is applied:

$$\text{EffectiveStat} = \text{TierBase} \times \text{stageMult} \times 1.01$$

**Key milestones — effective normal enemy stats (at end of each biome):**

| Stage | Biome | stageMult | Eff. HP | Eff. Power | Eff. Defense |
|------:|:------|----------:|--------:|-----------:|-------------:|
| 1,000 | Forest | ×2.50 | 378 | 38 | 25 |
| 2,000 | Swamp | ×4.00 | 1,414 | 121 | 101 |
| 3,000 | Mountains | ×5.50 | 3,889 | 305 | 250 |
| 4,000 | Snowy | ×7.00 | 8,484 | 636 | 495 |
| 5,000 | Tropical | ×8.50 | 16,307 | 1,201 | 944 |
| 6,000 | Caverns | ×10.00 | 28,280 | 2,020 | 1,616 |
| 7,000 | Desert | ×11.50 | 46,460 | 3,253 | 2,552 |
| 8,000 | Volcanic | ×13.00 | 76,206 | 5,002 | 3,940 |
| 9,000 | Ruins | ×14.50 | 117,260 | 7,324 | 5,858 |
| 10,000 | Sky | ×16.00 | 177,760 | 10,504 | 8,403 |
| 12,000 | Underground | ×19.00 | 335,950 | 19,530 | 15,915 |
| 15,000 | Corruption | ×23.50 | 806,640 | 47,000 | 39,062 |
| 20,000 | Light | ×30.00 | 3,030,000 | 184,830 | 153,918 |

> **Note:** stageMult values are approximate (rounded for readability). Arena (20,001+) continues indefinitely using tier 21 base stats ×31.0+.
